//const webSocket = new WebSocket("ws://192.168.8.102:8080/StudentTracer2/chatenseignantendpoint");
//const webSocket = new WebSocket("ws://localhost:8080/StudentTracer2/chatenseignantendpoint");
let webSocket = null;
const connect = () => {
  webSocket = new WebSocket("ws://localhost:8080/StudentTracer2/chatenseignantendpoint");
